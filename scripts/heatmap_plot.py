...
data = pd.read_csv('graph_bit_selected.csv', index_col='index')
print(data)
sns.heatmap(data, cmap='viridis')
plt.xlabel('Fragments', fontsize=14)
plt.ylabel('Bonds', fontsize=14)
title = 'Encoding of Multi-level Bond Chemical Environments'
plt.title(title)
plt.xticks(rotation=30)
ytic = np.arange(0, 9)+0.5
plt.yticks(ytic, ['M0: C-C', 'M1: C-C', 'M2: C-H',
